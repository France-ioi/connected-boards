...
function getConnectionDialogHTML(availableConnectionMethods: ConnectionMethod[], strings, boardDefinitions, sensorDefinitions): string {
...
//boardDefinitions, infos, findSensorDefinition
